...
describe PayFoe::Transaction do
  ...
  it 'has instance variables id, user_form, user_to, type, amount'  do
    transaction = PayFoe::Transaction.new nil, nil, nil, "deposit", 200
    transaction.instance_variables.should eq instance_variables
  end

  let(:transaction) { PayFoe::Transaction.new nil, PayFoe::LazyObject.new(1), PayFoe::LazyObject.new(2), "deposit", 200 }
  ...
  describe '#user_from' do
    ...
    it 'returns the correct user' do
      user = PayFoe::User.new 1, nil, nil, nil
